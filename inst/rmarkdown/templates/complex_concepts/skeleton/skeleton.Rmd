...
```{r echo=FALSE}
# Do a bunch of things se we can have nice labels instead of short variable names.
# This section creates a customized data frame that we use to do the analysis.
